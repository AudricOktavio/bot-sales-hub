    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800 overflow-hidden">
      ...
      <section className="container mx-auto px-4 pb-24 relative">
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-xl text-slate-300 max-w-2xl mx-auto">
            Built for modern teams who demand more from their CRM
          </p>
        </div>

        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {/* Feature 1 */}
          <Card className="bg-slate-800/50 backdrop-blur-sm border-white/10 hover:border-primary/50 transition-all duration-300 hover:-translate-y-2 group">
            <CardContent className="p-6">
              ...
              <p className="text-slate-400">
                Deploy intelligent agents that handle customer interactions, qualification, and follow-ups automatically.
              </p>
            </CardContent>
          </Card>

          {/* Feature 2 */}
          <Card className="bg-slate-800/50 backdrop-blur-sm border-white/10 hover:border-accent/50 transition-all duration-300 hover:-translate-y-2 group">
            <CardContent className="p-6">
              ...
              <p className="text-slate-400">
                Machine learning algorithms predict customer behavior and suggest optimal actions in real-time.
              </p>
            </CardContent>
          </Card>

          {/* Feature 3 */}
          <Card className="bg-slate-800/50 backdrop-blur-sm border-white/10 hover:border-secondary/50 transition-all duration-300 hover:-translate-y-2 group">
            <CardContent className="p-6">
              ...
              <p className="text-slate-400">
                Process thousands of interactions simultaneously with sub-second response times.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-slate-800/50 backdrop-blur-sm border-white/10 hover:border-accent/50 transition-all duration-300 hover:-translate-y-2 group">
            <CardContent className="p-6">
              ...
              <p className="text-slate-400">
                Real-time insights and forecasting powered by AI to optimize your sales pipeline.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-slate-800/50 backdrop-blur-sm border-white/10 hover:border-secondary/50 transition-all duration-300 hover:-translate-y-2 group">
            <CardContent className="p-6">
              ...
              <p className="text-slate-400">
                Connect with your existing tools and workflows through 500+ native integrations.
              </p>
            </CardContent>
          </Card>
        </div>
      ...
      <section className="container mx-auto px-4 pb-24 relative">
        ...
        <div className="relative">
          ...
          <Card className="relative bg-slate-800/70 backdrop-blur-xl border-white/20 shadow-2xl overflow-hidden">
            <CardContent className="p-8">
              ...
              <div className="flex items-center justify-between pt-4 border-t border-white/10">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-slate-400">AI Agents Active</span>
                </div>
