...
const Index = () => {
  ...
  const demos = [
    {
      ...
      messages: [
        {
          sender: "bot",
          text: "Hi! I'm Sarah, your personal shopping assistant. Looking for something special today?",
          delay: 1000,
        },
        {
          sender: "customer",
          text: "Hi! I need a laptop for graphic design work",
          delay: 2000,
        },
        {
          sender: "bot",
          text: "Perfect! For graphic design, I'd recommend our MacBook Pro 16\" with M3 Max chip. It has exceptional performance for design work. Would you like to see the specs?",
          delay: 3000,
        },
        { sender: "customer", text: "Yes, that sounds great!", delay: 4000 },
        {
          sender: "bot",
          text: '✅ Deal closed: $2,499 MacBook Pro 16"',
          delay: 5000,
          isResult: true,
        },
      ],
    },
    {
      ...
      messages: [
        {
          sender: "bot",
          text: "Hello! I'm Alex from Prime Properties. Are you looking to buy or sell?",
          delay: 1000,
        },
        {
          sender: "customer",
          text: "I'm looking for a 3-bedroom house under $500k",
          delay: 2000,
        },
        {
          sender: "bot",
          text: "Great! I have 3 properties that match perfectly. All in excellent neighborhoods with good schools. When would you like to schedule viewings?",
          delay: 3000,
        },
        {
          sender: "customer",
          text: "This weekend would be perfect",
          delay: 4000,
        },
        {
          sender: "bot",
          text: "📅 3 viewings scheduled for Saturday 10am-2pm",
          delay: 5000,
          isResult: true,
        },
      ],
    },
    {
      ...
      messages: [
        {
          sender: "bot",
          text: "Hi there! I'm Emma from CloudFlow. I see you're interested in our project management solution?",
          delay: 1000,
        },
        {
          sender: "customer",
          text: "Yes, my team of 20 needs better collaboration tools",
          delay: 2000,
        },
        {
          sender: "bot",
          text: "Perfect fit! Our Enterprise plan supports unlimited team members with advanced reporting. I can offer you a 30-day trial and 20% off the first year. Interested?",
          delay: 3000,
        },
        {
          sender: "customer",
          text: "That sounds like exactly what we need!",
          delay: 4000,
        },
        {
          sender: "bot",
          text: "💼 Trial started + 20% discount applied ($2,400/year)",
          delay: 5000,
          isResult: true,
        },
      ],
  ...
  const integrations = [
    {
      name: "SAP",
      imageSrc: "/lovable-uploads/c2d3129c-b7e5-4219-ac07-af0019719125.png",
      delay: 0,
    },
    { name: "Odoo", icon: Settings, color: "text-purple-600", delay: 200 },
    {
      name: "Midtrans",
      imageSrc: "/lovable-uploads/17134334-27db-490e-b585-8c7a003ceee5.png",
      delay: 400,
    },
    {
      name: "WhatsApp",
      imageSrc: "/lovable-uploads/e3a2e55e-12f2-448e-80ad-1ebd4004b319.png",
      delay: 600,
    },
    {
      name: "OneDrive",
      imageSrc: "/lovable-uploads/15679a59-be93-4738-8864-7e495dcb4d23.png",
      delay: 800,
    },
    {
      name: "Google Drive",
      imageSrc: "/lovable-uploads/23159d50-feaa-4804-a06a-57daed92fc25.png",
      delay: 1000,
    },
  ];
  ...
  const workflowSteps = [
    ...
    },
    {
      step: "AI Processing",
      icon: Brain,
      description: "AI analyzes intent and context",
    },
    {
      step: "CRM Query",
      icon: Database,
      description: "Checks SAP/Odoo for inventory & pricing",
    },
    {
      step: "Response Generation",
      icon: Zap,
      description: "Crafts personalized response",
    },
    {
      step: "Payment Link",
      icon: CreditCard,
      description: "Generates secure Midtrans payment",
    },
  ];

  // Pricing plans - base prices
  // Monthly = original price + 20%, Annual = original price × 12
  const basePricingPlans = [
    {
      name: "Essential",
      description: "Perfect for small businesses getting started",
      monthlyPrice: "2,159K", // 1,799K + 20%
      annualPrice: "21,588K", // 1,799K × 12
      responses: "15,000",
      channels: "WhatsApp",
    ...
    },
    {
      ...
      monthlyPrice: "5,399K", // 4,499K + 20%
      annualPrice: "53,988K", // 4,499K × 12
      responses: "50,000",
      channels: "WhatsApp",
  ...
  // Get current pricing based on billing period
  const pricingPlans = basePricingPlans.map((plan) => ({
    ...plan,
    price: billingPeriod === "monthly" ? plan.monthlyPrice : plan.annualPrice,
    period: plan.monthlyPrice === "Contact Sales" ? "" : billingPeriod === "monthly" ? "/month" : "/year",
  }));
  ...
  const agentTones = [
    {
      ...
      sample:
        "Good day! I'd be happy to assist you with finding the perfect solution for your business needs.",
    },
    {
      name: "Friendly",
      description: "Warm, conversational tone",
      sample:
        "Hey there! 😊 I'm excited to help you find exactly what you're looking for today!",
    },
    {
      name: "Empathetic",
      description: "Understanding, caring approach",
      sample:
        "I understand this might be a big decision for you. Let me help guide you through the options at your own pace.",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800 overflow-hidden">
      ...
      <nav className="container mx-auto px-4 py-6 flex justify-between items-center relative z-50">
        <div className="text-2xl font-bold text-white">Valvia</div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center relative z-10">
            ...
            <div className="space-y-8 animate-fade-in z-10">
              ...
              <p className="text-xl md:text-2xl text-slate-300 leading-relaxed max-w-2xl">
                Valvia transforms customer relationships with autonomous AI
                agents that work 24/7, making every interaction intelligent,
      ...
      <div className="bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900">
        <div className="container mx-auto px-4 py-12">
          ...
          <section id="use-cases" className="max-w-6xl mx-auto mb-20">
            <div className="text-center mb-12 animate-fade-in">
              ...
              <p className="text-slate-300 text-lg">
                Watch real conversations and see how AI agents convert leads
          ...
          <section className="max-w-6xl mx-auto mb-20">
            <div className="text-center mb-12 animate-fade-in">
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
                Streamline Every Step of Your Sales Process from Inquiry to
                Closing
              </h2>
              <p className="text-slate-300 text-lg">
                See how Valvia processes customer requests and generates
                ...
                {workflowSteps.map((step, index) => (
                  <div key={index} className="flex items-center">
                    ...
                    >
                      ...
                      <p
                        className={`text-sm font-medium text-center max-w-20 transition-colors duration-500 ${
                          activeStep === index
                            ? "text-primary"
                            : "text-slate-400"
                        }`}
                    ...
                    {index < workflowSteps.length - 1 && (
                      <ArrowRight
                        className={`h-6 w-6 mx-2 transition-colors duration-500 ${
                          activeStep === index
                            ? "text-primary"
                            : "text-slate-600"
                        }`}
          ...
          <section className="max-w-6xl mx-auto mb-20">
            <div className="text-center mb-12 animate-fade-in">
              ...
              <p className="text-slate-300 text-lg">
                From customer inquiries to closed deals - your AI agent manages
                it all
              </p>
            </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-slate-400 mb-3">
                        AI agents automatically process orders, check inventory
                        in real-time, generate invoices, and update order status
                ...
                <Card className="p-6 hover:shadow-xl hover:shadow-accent/20 transition-all duration-300 border border-white/10 bg-slate-800/50 backdrop-blur-sm hover:border-accent/50">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-slate-400 mb-3">
                        Access comprehensive analytics and insights to make
                        informed business decisions. Track performance,
                        conversion rates, and revenue in real-time.
                      </p>
                      <div className="flex flex-wrap gap-2">
                        <Badge
                          variant="secondary"
                ...
                <Card className="p-6 hover:shadow-xl hover:shadow-secondary/20 transition-all duration-300 border border-white/10 bg-slate-800/50 backdrop-blur-sm hover:border-secondary/50">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-slate-400 mb-3">
                        AI agents have instant access to your complete product
                        catalog, pricing, and stock levels through direct
                        integration with SAP, Odoo, or your WMS.
                      </p>
                      <div className="flex flex-wrap gap-2">
                        <Badge
                          variant="secondary"
          ...
          <section id="features" className="max-w-6xl mx-auto mb-20">
            <div className="text-center mb-12 animate-fade-in">
              ...
              <p className="text-slate-300 text-lg">
                Everything you need to manage, deploy, and optimize AI sales
                agents
              </p>
            </div>
            ...
            <Tabs defaultValue="agents" className="w-full">
              <TabsList className="grid w-full grid-cols-3 mb-8 bg-slate-800/50 backdrop-blur-sm border-white/10">
                <TabsTrigger
                  value="agents"
                  className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-primary data-[state=active]:to-secondary data-[state=active]:text-white text-slate-400"
                >
                  AI Agent Management
                </TabsTrigger>
                <TabsTrigger
                    ...
                    <div className="space-y-4">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-slate-400">
                            Train agents with your brand voice and sales
                            approach
                          </p>
                        </div>
                      </div>
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-slate-400">
                            Upload catalogs and train on your specific offerings
                          </p>
                        </div>
                      </div>
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-slate-400">
                            Deploy on website, WhatsApp, SMS, and email
                          </p>
                        </div>
                      </div>
                    </div>
                ...
                <div className="grid md:grid-cols-2 gap-8 items-center">
                  ...
                  <div>
                    ...
                    <p className="text-slate-400 mb-4">
                      Track every lead from first contact to closed deal. AI
                      agents automatically update lead status and schedule
                      follow-ups.
                    </p>
              ...
              <TabsContent value="analytics" className="space-y-6">
                <div className="grid md:grid-cols-2 gap-8 items-center">
                  <div>
                    ...
                    <p className="text-slate-400 mb-4">
                      Get insights into every customer interaction. Understand
                      what works, optimize agent performance, and improve
                      conversion rates.
                    </p>
          ...
          <section id="integrations" className="max-w-6xl mx-auto mb-20">
            <div className="text-center mb-12 animate-fade-in">
              ...
              <p className="text-slate-300 text-lg">
                Unify Your Customer Relationship Management Systems and Data.
                Safely.
              </p>
            </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 relative">
                {integrations.map((integration, index) => (
                  <div key={integration.name} className="relative">
                    ...
                    <div
                      className={`absolute top-6 left-1/2 w-px h-20 bg-gradient-to-t from-primary/30 to-transparent transform -translate-x-1/2 -translate-y-full animate-pulse`}
          ...
          <section id="pricing" className="max-w-6xl mx-auto mb-20 px-4">
            <div className="text-center mb-12 animate-fade-in">
              ...
              {/* Billing Toggle */}
              <div className="inline-flex items-center bg-slate-800/50 backdrop-blur-sm border border-white/10 rounded-full p-1 mb-8">
                <button
                  onClick={() => setBillingPeriod("monthly")}
                  className={`px-4 sm:px-6 py-2 text-xs sm:text-sm font-medium rounded-full transition-all ${
                ...
                <button
                  ...
                  className={`px-4 sm:px-6 py-2 text-xs sm:text-sm font-medium rounded-full transition-all flex items-center gap-1 sm:gap-2 ${
                ...
                >
                  Annual
                  <span className="text-[10px] sm:text-xs bg-green-500/20 text-green-400 border border-green-500/30 px-1.5 sm:px-2 py-0.5 rounded-full whitespace-nowrap">
                    Save 20%
                  </span>
                </button>
              </div>
          ...
          <div className="text-center max-w-2xl mx-auto pb-20">
            ...
            <p className="text-slate-300 text-lg mb-8">
              Join thousands of teams already using Valvia to automate customer
              relationships and drive unprecedented growth with AI-powered
              intelligence.
            </p>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="md:col-span-1">
              ...
              <p className="text-slate-400 mb-4">PT PORTA OKULER TEKNOLOGI</p>
          ...
          <div className="border-t border-white/10 mt-8 pt-8 text-center text-slate-500 text-sm">
            <p>
              &copy; 2025 Valvia by PT PORTA OKULER TEKNOLOGI. All rights
              reserved.
            </p>
          </div>
        </div>
